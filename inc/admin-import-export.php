<?php
    ...
    function wprss_import_export_settings_page() {
        ...
        <div class="wrap">
            ...
            <p><?php _e( 'Click Browse button and choose a json file that you backup before.', 'wprss' ); ?></p>
            <p><?php _e( 'Press Restore button, WordPress do the rest for you.', 'wprss' ); ?></p>
        ...
        else if ( check_admin_referer( 'wprss-settings-export' ) ) {  
            $blogname = str_replace( " ", "", get_option( 'blogname' ) );
            $date = date( "m-d-Y" );
            $json_name = $blogname . "-" . $date; // Naming the filename that will be generated.

            $options = array( 'wprss_settings' => get_option( 'wprss_settings' ) );
