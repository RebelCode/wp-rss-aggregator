<?php
    ...
    /**
    * SimplePieExtender class
    *
    * @since[*next-version*]
    */
    class SimplePieExtender extends SimplePie{
	 ...
	 * parsed, and all of that other good stuff.
         * 
         * Copied from wp-includes/class-simplepie.php
	 *
	...
	public function init()
	{
		...
		foreach ($encodings as $encoding)		{
                        ...
                        // Trim the data so that feeds with whitespace at beginning also validates
