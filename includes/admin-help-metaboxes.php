...
if( class_exists('WPRSS_Help') ) {
    ...
    $tooltips = array(
         ...
         */
            ...
            '),
            // Link to Enclosure
            'wprss_enclosure'       => wpautop('
                Tick this box to make feed items link to their enclosure URL, rather than link to the original article.
         ...
         */
            ...
            '),
            // Activate Feed: [date]
            'wprss_activate_feed'   => 'You can set a time in the future when the feed source will become active, if it is paused.',
            // Pause Feed: [date]
            'wprss_pause_feed'      => 'You can set a time in the future when the feed source will become paused, if it is active.',
            // Update Interval
            'wprss_update_interval' => wpautop('
            ...
            'wprss_age_limit'       => wpautop('
                ...
                Leaving this setting to <em>Default</em> will use the <em>Limit feed items by age</em> option in the general settings.
            '),
         ...
         */
        // Force Feed
        'wprss_force_feed'      => wpautop('
            Use this option if you are seeing an "Invalid feed URL" error in the Feed Preview above, but you are sure that the URL is correct.
