<?php
    ...
    function wprss_register_menu_pages() {
        ...
        add_submenu_page( 'edit.php?post_type=wprss_feed', __( 'More Features With Our Premium Add-Ons', WPRSS_TEXT_DOMAIN ), __( 'More Features', WPRSS_TEXT_DOMAIN ) . '<span class="dashicons dashicons-star-filled wprss-more-features-glyph"></span>', apply_filters( 'wprss_capability', 'manage_feed_settings'), 'wprss-addons', 'wprss_addons_page_display' );
